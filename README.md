...
If it’s an absolute URL → used as-is.

Else → PHOTOS_BASE_URL + PhotoName.

If missing or not found → fallback to user.png.
...
5. Image Rendering
Uses @napi-rs/canvas to generate a 1366x768 PNG.
